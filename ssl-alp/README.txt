...
ALP (Academic Labbook Plugin) is a lightweight WordPress plugin that turns the
blogging platform into a collaborative laboratory notebook.
...
== Rough project goals ==
 - Leverage as much functionality already included in WordPress as possible
