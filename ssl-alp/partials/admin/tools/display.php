	...
	<div class="ssl-alp-tools-cards">
		...
		<div class="ssl-alp-tools-card">
			...
			<ul>
				...
				<li><?php printf( __( 'The <strong>%1$s</strong> role is changed to <strong>%2$s</strong>. This is intended for research group members. Users with this role can, among other capabilities, create, edit and delete their own and others\' posts and pages, and manage comments, categories and uploaded media. This role is the default for new users.', 'ssl-alp' ), __( 'Editor' ), __( 'Researcher', 'ssl-alp' ) ); ?></li>
				<li><?php printf( __( 'The <strong>%1$s</strong> role is changed to <strong>%2$s</strong>. This roles is intended for temporary group members. Users with this role are able to create, edit and delete their own posts and pages, but not those of other users. They cannot manage categories or others\' comments.', 'ssl-alp' ), __( 'Author' ), __( 'Intern', 'ssl-alp' ) ); ?></li>
