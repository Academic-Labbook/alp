...
<label for="ssl_alp_flag_unread_posts_checkbox">
    ...
    <?php _e( 'Flag unread posts for logged-in users', 'ssl-alp' ); ?>
</label>
<p class="description"><?php _e( 'When enabled, unread posts are marked for logged in users, and themes may use this information to change the way the post is displayed. When an edit is made to a post, the unread status is reset for each user.', 'ssl-alp' ); ?></p>
