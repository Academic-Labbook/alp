<fieldset>
    ...
    <label for="ssl_alp_katex_use_custom_urls_checkbox">
        ...
        <p class="description"><?php echo wp_kses_post( sprintf( __( 'When enabled, the <a href="%s">KaTeX</a> JavaScript and CSS scripts used to render mathematical markup on posts and pages will be loaded using the URLs specified below instead of the defaults. The <a href="%s">Copy-tex extension</a> provides the ability to copy TeX source code from rendered mathematics.', 'ssl-alp' ), 'https://katex.org/', 'https://katex.org/docs/libs.html#extensions' ) ); ?></p>
    </label>
    <br/>
