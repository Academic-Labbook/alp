<label for="ssl_alp_enable_tex_checkbox">
    ...
    <p class="description"><?php echo wp_kses_post( sprintf( __( 'When enabled, a block is added to the editor that allows users to write <a href="%s">TeX-formatted mathematics</a>.', 'ssl-alp' ), 'https://en.wikibooks.org/wiki/LaTeX/Mathematics' ) ); ?></p>
</label>
