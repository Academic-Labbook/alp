<label for="ssl_alp_disallow_public_advanced_search_checkbox">
    ...
    <p class="description"><?php _e( 'When enabled, users who have not logged in will not be able to make computationally expensive advanced searches, such as those that match against multiple authors, categories and tags. They will still be able to make basic searches.', 'ssl-alp' ); ?></p>
</label>
