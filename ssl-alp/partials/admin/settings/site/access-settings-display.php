<label for="ssl_alp_require_login_checkbox">
    ...
    <p class="description"><?php echo wp_kses_post( sprintf( __( 'Note that this will <strong>not</strong> prevent direct access to media (images, documents, videos, etc.) uploaded to the site for those knowing the URL. If desired, this behaviour should be configured using your HTTP server. You may wish to <a href="%s">optimise private labbook settings</a> after enabling this.', 'ssl-alp' ), 'tools.php?page=ssl-alp-admin-tools' ) ); ?></p>
</label>
<br/>
