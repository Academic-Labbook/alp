<p>
    <label for="ssl_alp_require_login_checkbox">
        ...
        <p class="description"><?php _e( 'You may wish to <a href="tools.php?page=ssl-alp-admin-tools">optimise private labbook settings</a> after enabling this.', 'ssl-alp' ); ?></p>
    </label>
</p>
