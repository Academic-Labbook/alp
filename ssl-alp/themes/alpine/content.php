	...
	<?php
		...
		<?php if ( 'excerpt' === $content_layout ) : ?>
	 	...
	 	<?php else : ?>
			...
			<?php
			// Excerpt with thumb.
			$archive_image_thumbnail_size = esc_attr( ssl_alp_get_option( 'archive_image_thumbnail_size' ) );
			$archive_image_alignment = esc_attr( ssl_alp_get_option( 'archive_image_alignment' ) );
			?>
